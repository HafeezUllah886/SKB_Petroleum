...
<head>
    ...
    <title>Drop Shipping - Check Posts</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Check Posts</h1>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add New Check Post</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="sup_name">Post Name</label>
                        <input type="text" required class="form-control form-control-user" placeholder="Enter Post Name" id="acct_title" name="acct_title">
                    </div>
                    <div class="form-group">
                        <label for="sup_cont">Contact No.</label>
                        <input type="text" required class="form-control form-control-user" placeholder="Enter Post Contact No." id="sup_cont" name="sup_cont">
                    </div>
                    <div class="form-group">
                        <label for="acct_no">Account No.</label>
                        <input type="text" required class="form-control form-control-user" placeholder="Enter Post Account No." id="acct_no" name="acct_no">
                    </div>
                    <div class="form-group">
...
<script>
    function get_sup(){
    $("#show_sup").load("supported/show_sup.php?type=posts");
}
    ...
    function edit(id)
    {
        $.post("supported/get_e_sup.php?type=posts",{id:id},function (e){
            $("#sup_e_form").html(e);
        });
        $("#edit-sup").modal('show');
    }
...
$("#save").click(function (){
    ...
    $.post("supported/save_sup.php?type=posts",data,function(msg){
        if(msg == 'done')
        {
            $.post("supported/save_acct.php?type=post",data,function(acct_msg){
                swal({
                  title: "Saved",
                  icon: "success",
                  dangerMode: true
...
//Start of Save Edit Supplier
    ...
    $("#save_e").click(function (){
        ...
        $.post("supported/save_e_sup.php?type=posts",data_e,function(msg_e){
            console.log();
            if(msg_e == 'done')
            {
                swal({
