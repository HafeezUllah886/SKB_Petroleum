...
<head>
    ...
    <title>Pump Management - Transfer</title>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <optgroup label="Business">
                           ...
                           <?php 
                                $acct1 = mysqli_query($con, "select * from ppmaccounts where type = 'Customer' and status = 'Active'");
                           ...
                           <?php 
                                $acct1 = mysqli_query($con, "select * from ppmaccounts where type = 'Other' and status = 'Active'");
                                while($op1 = mysqli_fetch_array($acct1))
                                {
                                    ?>
                                        <option value="<?php echo $op1['id']?>"><?php echo $op1['name'];?></option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-user" name="to">
                        <optgroup label="Business">
                           <?php 
                                $acct2 = mysqli_query($con, "select * from ppmaccounts where type = 'business' and status = 'Active'");
                           ...
                           <?php 
                                $acct3 = mysqli_query($con, "select * from ppmaccounts where type = 'supplier' and status = 'Active'");
                           ...
                           <?php 
                                $acct4 = mysqli_query($con, "select * from ppmaccounts where type = 'Other'");
