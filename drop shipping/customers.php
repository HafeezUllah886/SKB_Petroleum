...
<head>
    ...
    <title>Drop Shipping - Customers</title>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="sup_name">Customer Name</label>
...
<script>
    function get_sup(){
    $("#show_sup").load("supported/show_sup.php?type=customers");
}
    ...
    function edit(id)
    {
        $.post("supported/get_e_sup.php?type=customers",{id:id},function (e){
            $("#sup_e_form").html(e);
        });
        $("#edit-sup").modal('show');
    }
...
$("#save").click(function (){
    ...
    $.post("supported/save_sup.php?type=customers",data,function(msg){
        if(msg == 'done')
        {
            $.post("supported/save_acct.php?type=customer",data,function(acct_msg){
                swal({
                  title: "Saved",
                  icon: "success",
                  dangerMode: true
...
//Start of Save Edit Supplier
    ...
    $("#save_e").click(function (){
        ...
        $.post("supported/save_e_sup.php?type=customers",data_e,function(msg_e){
            console.log();
            if(msg_e == 'done')
            {
                swal({
