...
<head>
    ...
    <title>Drop Shipping - Print IN / Out Cash</title>
    ...
    <!-- Page Wrapper -->
                                ...
                                <link href="css/sb-admin-2.min.css" rel="stylesheet">
                                    <div>
                                        ...
                                        <h5 class="d-flex justify-content-center"> TRANSFER CASH STATEMENT </h5>
                                    </div>
                                    <div>
                                        <hr>
...
<table style="border:1px;width:100%;" border="1px">
    ...
    <tbody>
<?php
$get = mysqli_query($con, "select * from transfer where date between '$from' and '$to'");
