...
<head>
    ...
    <title>Pump Management - Sale</title>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-md-6 mb-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-control-user" id="cust" name="cust">
                                                   <?php
                                                        $get_sup = mysqli_query($con, "select id, name from ppmaccounts where type='Customer' and status = 'active'");
                                        ...
                                        <div class="col-xl-4 col-md-6 mb-4">
                                            <div class="form-group">
                                            <label for="btn"> </label>
                                                <input type="submit" value="Save" class="btn btn-info form-control form-control-user" id="save">
                                            </div>
                                        </div>
...
<script>
    ...
    $("#save").click(function (){
        ...
        $.post("supported/save_sale.php",$all_data,function (order_msg){
