...
<head>
    ...
    <title>Drop Shipping - Supplier Accounts</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Supplier Accounts</h1>
...
<script>
    function get_acct(){
    $("#show_acct").load("supported/show_acct.php?type=supplier");
}
...
//Start of Save Edit Supplier
    ...
    $("#save_e").click(function (){
        ...
        $.post("supported/save_e_acct.php?type=suppliers",data_e,function(msg_e){
            console.log(msg_e);
            if(msg_e == 'done')
            {
                swal({
