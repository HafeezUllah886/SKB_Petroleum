...
<head>
    ...
    <title>Drop Shipping - Products</title>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="pro_pur">Purchase Rate</label>
                        <input type="number" required class="form-control form-control-user" placeholder="Enter Purchase Rate" id="pro_pur" name="pro_pur">
                    </div>
                    <div class="form-group">
