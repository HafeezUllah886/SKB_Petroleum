...
<head>
    ...
    <title>Pump Management - Cash In/Out</title>
...
<script>
  function get_orders(){
    ...
    $.post("supported/inout.php",filter,function (state){
...
$("#printbtn").click(function (){
    var from = $("#from").val();
    var to = $("#to").val();
    window.open("print_inout.php?from="+from+"&to="+to,"_self");
...
.then((value) => {
  $.post('supported/checkpass.php',{value:value},function(result){
    if(result == 'correct')
    {
        $.post('supported/delete_inout.php?tr_no='+id, function(dmsg){
