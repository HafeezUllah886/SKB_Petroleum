...
<head>
    ...
    <title>Pump Management - Profit</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Estimated Profit</h1>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <p class="btn btn-warning btn-sm" id="printbtn">Print</p>    
...
function get_exp(){
    ...
    $.post("supported/prof.php",filter,function (state){
        $("#show_exp").html(state);
    });
}
...
$("#printbtn").click(function (){
    var from = $("#from").val();
    var to = $("#to").val();
    window.open("print_prof.php?from="+from+"&to="+to,"_self");
   });
</script>
