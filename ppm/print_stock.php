...
$ac_name = $get_name['pro'];
$ac_type = $get_name['unit'];
...
<head>
    ...
    <title>Pump Management - Stock Print</title>
    ...
    <!-- Page Wrapper -->
                                ...
                                <link href="css/sb-admin-2.min.css" rel="stylesheet">
                                    <div>
                                        ...
                                        <h5 class="d-flex justify-content-center"> STOCK STATEMENT </h5>
                                    </div>
                                    <div>
                                        <hr>
                                        <table style="border:1px;width:100%;">
                                            <tr>
                                                <td width="40%">Product: <?php echo $ac_name; ?></td>
                                                <td width="20%">Unit: <?php echo $ac_type; ?> </td>
                                        ...
                                        <table style="border:1px;width:100%;">
                                            <tr>
                                                <td width="50%" style="font-size:15px;text-align:center;"> <span style="font-size:20px;"><?php echo $p_bal . ' ' . $ac_type; ?> </span><br> Opening</td>
                                                <td width="50%" style="font-size:15px;text-align:center;"> <span style="font-size:20px;"><?php echo $c_bal . ' ' . $ac_type; ?> </span><br> Closing</td>
