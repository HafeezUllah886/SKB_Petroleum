...
<head>
    ...
    <title>Pump Management - Purchase History</title>
...
<script>
    ...
    $.post("supported/show_pur.php",filter,function (orders){
...
.then((value) => {
  $.post('supported/checkpass.php',{value:value},function(result){
    if(result == 'correct')
    {
        $.post('supported/delete_pur.php?tr_no='+id, function(dmsg){

          swal("Poof! Purchase has been deleted!", {
            icon: "success",
      }).then(function (){
        get_orders();
      });
