                                ...
                                <table class="table" width="100%" style="min-width:700px;">
                                    ...
                                    <tbody>
                                       <?php 
                                        ...
                                        $from = $_POST['from'];
                                        $to = $_POST['to'];
                                        $get_orders = mysqli_query($con, "select * from ppmpurchase where date between '$from' and '$to'");
                                        $total = 0;
                                    ...
                                    <tfoot>
                                        <th colspan="6" style="text-align:right;">Total Purchase: </th>
